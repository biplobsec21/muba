    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" novalidate method="post" action="{{ url('admin/settings/category/'.Request::segment(4).'/update') }}" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input id="icon_name" class="form-control col-md-7 col-xs-12"  name="icon_name_hidden"  type="hidden" value="{{ $resourceData->icon }}">
                            
                             @if($resourceData->icon)
                            <div class="col-md-3 col-sm-12 col-xs-3">
                                 <br>
                                <img src="{{ asset('public/uploads_images/'.$resourceData->icon) }}" width="100" height="100" /> 
                            </div>
                        @endif
                        </div>
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Priority Order ( higher value will show first in API)

                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="priority_order" class="form-control col-md-7 col-xs-12"  name="priority_order" placeholder="priority_order"  type="number" value="{{ old('priority_order',$resourceData->priority_order ? $resourceData->priority_order:'') }}">
                        </div>
                    </div>
